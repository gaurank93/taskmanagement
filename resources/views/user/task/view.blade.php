                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {!! Form::open(['route'=>array('user-task.upload-document'), 'onsubmit'=>'BtnSubmit.disabled = true','method' => 'post','files'=>true]) !!}
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mt-4 p-1">
                                                <button type="submit" id="BtnSubmit" class="btn btn-primary w-md">
                                                    Upload
                                                </button>
                                            </div>
                                        </div>
