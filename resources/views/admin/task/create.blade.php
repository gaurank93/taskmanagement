        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(['route'=>array('task.store'), 'onsubmit'=>'BtnSubmit.disabled = true','method' => 'post']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="user_id" class="form-label">Assigned To User<span
                                                class="text-danger">*</span></label>
                                        {!! Form::select("user_id", [''=>'Select User Name']+$users, old('user_id'), ['class'=>'form-control', 'required'] ) !!}
