...
class TaskController extends Controller
{
    ...
    {
        $data = Task::find($id);
        return view('admin.task.view', compact('data'));
    }
    ...
    public function edit(string $id): View
    {
        $data = Task::find($id);
        $users = User::role('user')->pluck('name', 'id')->toArray();
        return view('admin.task.edit', compact('data', 'users'));
    }
    ...
    public function getData(): JsonResponse
    {
        ...
        return DataTables::of($data)
            ...
            ->editColumn('deadline', function ($datatables) {
                ...
                return '<a href="' . route('task.edit', $datatables->id) . '" class="btn btn-info btn-sm" title="Edit Detail"><i class="mdi mdi-pencil d-block font-size-16"></i></a>
                        <a href="' . route('task.show', $datatables->id) . '" class="btn btn-primary btn-sm" title="View Detail"><i class="mdi mdi-eye d-block font-size-16"></i></a>
    ...
    public function uploadDocument(Request $request)
    {
        ...
        return redirect()->route('task.show', $task_document->task_id);
    }
}
